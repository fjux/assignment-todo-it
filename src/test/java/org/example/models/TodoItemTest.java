...
public class TodoItemTest {
    ...
    public void setUp() {
        ...
        testObject = new TodoItem(TITLE, TASK_DESCRIPTION, DEADLINE, testPerson);
    }
    ...
    public void constructor_throws_exception_on_null_title() {
        new TodoItem(null, TASK_DESCRIPTION, DEADLINE, testPerson);
    }

    @Test(expected = RuntimeException.class)
    public void constructor_throws_exception_on_null_deadLine() {
        new TodoItem(TITLE, TASK_DESCRIPTION, null, testPerson);
    }
